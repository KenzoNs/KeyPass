...
CREATE TABLE IF NOT EXISTS `utilisateur` (
    ...
    `date_sortie_utilisateur` date,
    `email_utilisateur` varchar(150),
    `bip_utilisateur` varchar(150),
    `telephone_utilisateur` varchar(150),
    UNIQUE (email_utilisateur, telephone_utilisateur, identifiant_utilisateur),
